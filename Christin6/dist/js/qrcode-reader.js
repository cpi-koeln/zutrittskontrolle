;(function( $, window, document, undefined ) {
  ...
  QRCodeReader.prototype = {
    ...
    buildHTML: function() {
      ...
      qrr.outputDiv = $('<div id="qrr-output" class="w-12"></div>');
      qrr.outputNoData = $('<div id="qrr-nodata">Kein QR-Code erkannt!</div>');
        ...
        if (code && qrr.settings.qrcodeRegexp.test(code.data)) {
          ...
          if (qrr.settings.multiple) {
            ...
            if (qrr.settings.repeatTimeout > 0) {
              ...
              qrr.loadingMessage.text("Klick auf das Bild um den nächsten Code zu scannen!");
